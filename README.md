...
This Code is unstable and is in development, the app does not respond when it tries to translate a big chunk of code, because python is slow. So we are trying to fix this issue. Thank You
